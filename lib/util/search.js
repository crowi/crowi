...
SearchClient.prototype.search = function(query)
{
  ...
  return new Promise(function(resolve, reject) {
    debug('Search with query', JSON.stringify(query.body.query.bool));
...
SearchClient.prototype.appendCriteriaForDeboostingSpecificKeywords = function(query)
{
  ...
  query.body.query.bool.must.push(date_deboosting);
  ...
  query.body.query.bool.must.push(user_deboosting);
};
