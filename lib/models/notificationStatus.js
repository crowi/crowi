module.exports = function(crowi) {
  ...
  notificationStatusSchema.statics.findByUser = function(user) {
    ...
    return new Promise(function(resolve, reject) {
      ...
      NotifiationStatus.findOne(query).exec(function(err, notificationStatus) {
        if (err) {
          reject(err)
        }
  ...
  notificationStatusSchema.statics.updateIsReadFlag = function(user, flag) {
    ...
    return new Promise(function(resolve, reject) {
      ...
      NotifiationStatus.findOneAndUpdate(query, parameters, options).exec(function(err, notificationStatus) {
        if (err) {
          reject(err)
        }
