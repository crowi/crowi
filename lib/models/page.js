module.exports = function(crowi) {
  ...
  // 見直し期間設定の制約に利用
  pageSchema.methods.isOwned = function() {
    return this.populated('owners') ? this.owners.length > 0 : false
  }
  ...
  /**
   * @param {null, undefined, object} lifetime
   */
  pageSchema.methods.updateLifetime = async function(lifetime) {
    const page = this
    /**
