module.exports = function(crowi) {
  ...
  pageSchema.statics.findChildrenByPath = async function(path, userData, option) {
    ...
    option = Object.assign({ limit: 0 }, option)
    return this.findListByStartWith(path, userData, option)
  }
  ...
  pageSchema.statics.removePageByPath = function(pagePath) {
    ...
    return Page.findPageByPath(redirectPath).then(function(pageData) {
