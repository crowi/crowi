module.exports = function(crowi) {
  ...
  const LOCALE_DETECTED = 'detected'
  const LOCALE_SELECTED = 'selected'
  ...
  pageSchema.statics.removePageByPath = function(pagePath) {
    ...
    return Page.findPageByPath(pagePath).then(function(pageData) {
  ...
  pageSchema.statics.LOCALE_DETECTED = LOCALE_DETECTED
  pageSchema.statics.LOCALE_SELECTED = LOCALE_SELECTED
