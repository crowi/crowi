module.exports = function(crowi) {
  ...
  // TODO: FIX ME ;_;
  notificationSchema.virtual('latestActionUsers').get(function() {
    const Activity = crowi.model('Activity')
    return Activity.getActionUsersFromActivities(this.activities).slice(0, 3)
  })
  // TODO: FIX ME ;_;
  notificationSchema.virtual('actionUsersCount').get(function() {
    const Activity = crowi.model('Activity')
    return Activity.getActionUsersFromActivities(this.activities).length
  })
