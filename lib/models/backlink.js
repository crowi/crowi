module.exports = function(crowi) {
  ...
  backlinkSchema.statics.create = function(parameters) {
    var BackLink = this;
    ...
    return new Promise((resolve, reject) => {
      ...
      BackLink.findOneAndUpdate(conditions, data, options, (err, savedBackLink) => {
        if (err) {
          debug('Error on saving BackLink', err);
          return reject(err);
        }
        debug('BackLink saved');
      ...
      Promise
        ...
        .then((ids) => {
          ...
          ids.forEach(function(id) {
            ...
            createPromises.push(BackLink.create(parameters));
