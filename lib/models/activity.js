module.exports = function(crowi) {
  ...
  activitySchema.post('save', async function(savedActivity) {
    ...
    try {
      const [notificationTargetUsers, sameActivities] = await Promise.all([savedActivity.getNotificationTargetUsers(), savedActivity.getSameActivities()])

      const notificationPromises = notificationTargetUsers.map(user => {
