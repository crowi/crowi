module.exports = function(crowi) {
  ...
  userSchema.methods.hasValidThirdPartyId = function() {
    ...
    return (Config.googleLoginEnabled(config) && this.googleId) || (Config.githubLoginEnabled(config) && this.githubId)
  }
  ...
  userSchema.statics.findUserByGitHubId = function(githubId, callback) {
    this.findOne({ githubId: githubId }, function(err, userData) {
      callback(err, userData)
    })
  }
