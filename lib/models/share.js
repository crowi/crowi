module.exports = function(crowi) {
  ...
  shareSchema.statics.findShareByUuid = async function(uuid, query) {
    const self = this
  ...
  shareSchema.statics.delete = async function(shareData) {
    const Share = this
    const shareId = shareData._id
    return Share.findOneAndUpdate({ _id: shareId }, { status: STATUS_INACTIVE }, { new: true }).exec()
  }
