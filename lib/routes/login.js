module.exports = function(crowi, app) {
  ...
  var clearSession = function(req) {
    ...
    delete req.session.githubOrganizations; // for User.isGitHubAccountValid
  ...
  actions.register = function(req, res, next) {
    ...
    if (req.method == 'POST' && req.form.isValid) {
      ...
      var githubOrganizations = req.session.githubOrganizations || null;
  ...
  actions.registerGitHub = function(req, res, next) {
    ...
    if (!code) {
      ...
      githubAuth.handleCallback(req, res, next)(function(err, tokenInfo) {
        ...
        req.session.githubOrganizations = tokenInfo.organizations;
