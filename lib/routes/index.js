module.exports = function(crowi, app) {
  ...
  const handleError = middleware.handleError(crowi)
  ...
  app.get('/_api/teams.list', accessTokenParser, loginRequired(crowi, app), team.api.list, handleError)
  app.get('/_api/teams.get', accessTokenParser, loginRequired(crowi, app), team.api.get, handleError)
  app.post('/_api/teams.create', accessTokenParser, loginRequired(crowi, app), team.api.create, handleError)
  app.post('/_api/teams.edit', accessTokenParser, loginRequired(crowi, app), team.api.edit, handleError)

  app.post('/_api/pageOwners.activate', accessTokenParser, loginRequired(crowi, app), pageOwner.api.activate, handleError)
  app.post('/_api/pageOwners.deactivate', accessTokenParser, loginRequired(crowi, app), pageOwner.api.deactivate, handleError)
