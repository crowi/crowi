module.exports = function(crowi, app) {
  ...
  app.get( '/_notifications'          , accessTokenParser(crowi, app), loginRequired(crowi, app) , notification.notificationPage);
  app.get( '/_api/notification.list'  , accessTokenParser(crowi, app) , loginRequired(crowi, app) , notification.api.list);
  app.post( '/_api/notification.read' , accessTokenParser(crowi, app) , loginRequired(crowi, app) , notification.api.read);
  app.get( '/_api/notification.status', accessTokenParser(crowi, app) , loginRequired(crowi, app) , notification.api.status);
  app.post( '/_api/notification.status_read', accessTokenParser(crowi, app) , loginRequired(crowi, app) , notification.api.statusRead);
