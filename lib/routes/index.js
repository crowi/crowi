module.exports = function(crowi, app) {
  ...
  app.post('/_api/page_owners.activate', accessTokenParser, loginRequired(crowi, app), pageOwner.api.activate, team.middleware.handleError)
  app.post('/_api/page_owners.deactivate', accessTokenParser, loginRequired(crowi, app), pageOwner.api.deactivate, team.middleware.handleError)
