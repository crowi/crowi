module.exports = function(crowi, app) {
  ...
  app.post('/_api/teams.ownPage', accessTokenParser, loginRequired(crowi, app), team.api.ownPage, team.middleware.handleError)
  app.post('/_api/teams.disownPage', accessTokenParser, loginRequired(crowi, app), team.api.disownPage, team.middleware.handleError)
