module.exports = function(crowi, app) {
  ...
  app.get('/admin/app', loginRequired(crowi, app), middleware.adminRequired(), admin.index)
  app.get('/admin/notification', loginRequired(crowi, app), middleware.adminRequired(), admin.index)
  app.get('/admin/notification/slackAuth', loginRequired(crowi, app), middleware.adminRequired(), admin.notification.slackAuth)
  app.get('/admin/users', loginRequired(crowi, app), middleware.adminRequired(), admin.index)
  app.get('/admin/search', loginRequired(crowi, app), middleware.adminRequired(), admin.index)
  app.get('/admin/share', loginRequired(crowi, app), middleware.adminRequired(), admin.index)
  app.get('/admin/backlink', loginRequired(crowi, app), middleware.adminRequired(), admin.index)

  app.get('/_api/admin', loginRequired(crowi, app), middleware.adminRequired(), admin.api.index)
  app.get('/_api/admin/top', loginRequired(crowi, app), middleware.adminRequired(), admin.api.top.index)
  app.get('/_api/admin/app', loginRequired(crowi, app), middleware.adminRequired(), admin.api.app.index)
  app.get('/_api/admin/notification', loginRequired(crowi, app), middleware.adminRequired(), admin.api.notification.index)
  app.get('/_api/admin/users', loginRequired(crowi, app), middleware.adminRequired(), admin.api.user.index)
  app.get('/_api/admin/users.search', loginRequired(crowi, app), middleware.adminRequired(), admin.api.usersSearch)

  app.post('/_api/admin/settings/app', loginRequired(crowi, app), middleware.adminRequired(), csrf, form.admin.app, admin.api.postSettings)
  app.post('/_api/admin/settings/sec', loginRequired(crowi, app), middleware.adminRequired(), form.admin.sec, admin.api.postSettings)
  app.post('/_api/admin/settings/mail', loginRequired(crowi, app), middleware.adminRequired(), csrf, form.admin.mail, admin.api.postSettings)
  app.post('/_api/admin/settings/aws', loginRequired(crowi, app), middleware.adminRequired(), csrf, form.admin.aws, admin.api.postSettings)
  app.post('/_api/admin/settings/google', loginRequired(crowi, app), middleware.adminRequired(), csrf, form.admin.google, admin.api.postSettings)
  app.post('/_api/admin/settings/github', loginRequired(crowi, app), middleware.adminRequired(), csrf, form.admin.github, admin.api.postSettings)
  app.post('/_api/admin/settings/share', loginRequired(crowi, app), middleware.adminRequired(), csrf, form.admin.share, admin.api.postSettings)

  app.post('/_api/admin/search/build', loginRequired(crowi, app), middleware.adminRequired(), csrf, admin.api.search.buildIndex)

  app.post('/_api/admin/notification/slackSetting', loginRequired(crowi, app), adminRequired, csrf, form.admin.slackSetting, admin.notification.slackSetting)
  ...
  app.post('/_api/admin/user/invite', loginRequired(crowi, app), middleware.adminRequired(), csrf, form.admin.userInvite, admin.api.user.invite)
  app.post('/_api/admin/user/:id/makeAdmin', loginRequired(crowi, app), middleware.adminRequired(), csrf, admin.api.user.makeAdmin)
  app.post('/_api/admin/user/:id/removeFromAdmin', loginRequired(crowi, app), middleware.adminRequired(), admin.api.user.removeFromAdmin)
  app.post('/_api/admin/user/:id/activate', loginRequired(crowi, app), middleware.adminRequired(), csrf, admin.api.user.activate)
  app.post('/_api/admin/user/:id/suspend', loginRequired(crowi, app), middleware.adminRequired(), csrf, admin.api.user.suspend)
  // app.post('/_api/admin/user/:id/remove', loginRequired(crowi, app), middleware.adminRequired(), csrf, admin.api.user.remove)
  // app.post('/_api/admin/user/:id/removeCompletely', loginRequired(crowi, app), middleware.adminRequired(), csrf, admin.api.user.removeCompletely)
  ...
  app.post('/_api/admin/backlink/build', loginRequired(crowi, app), middleware.adminRequired(), csrf, admin.api.backlink.buildBacklinks)
