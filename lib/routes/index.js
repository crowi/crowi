module.exports = function(crowi, app) {
  ...
  app.post('/_api/pageOwners.activate', accessTokenParser, loginRequired(crowi, app), pageOwner.api.activate, team.middleware.handleError)
  app.post('/_api/pageOwners.deactivate', accessTokenParser, loginRequired(crowi, app), pageOwner.api.deactivate, team.middleware.handleError)
