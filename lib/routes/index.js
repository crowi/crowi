module.exports = function(crowi, app) {
  ...
  var notification = require('./notification')(crowi, app)
  var backlink = require('./backlink')(crowi, app)
  var team = require('./team')(crowi, app)
  var pageOwner = require('./pageOwner')(crowi, app)
  ...
  app.get('/me/notifications', loginRequired(crowi, app), me.notifications)
  ...
  app.get('/_notifications', accessTokenParser, loginRequired(crowi, app), notification.notificationPage)
  app.get('/_api/notification.list', accessTokenParser, loginRequired(crowi, app), notification.api.list)
  app.post('/_api/notification.read', accessTokenParser, loginRequired(crowi, app), notification.api.read)
  app.post('/_api/notification.open', accessTokenParser, loginRequired(crowi, app), notification.api.open)
  app.get('/_api/notification.status', accessTokenParser, loginRequired(crowi, app), notification.api.status)
  ...
  app.get('/_api/pages.watch.status', accessTokenParser, loginRequired(crowi, app), page.api.watchStatus)
  app.post('/_api/pages.watch', accessTokenParser, loginRequired(crowi, app), page.api.watch)
  app.post('/_api/pages.updateLifetime', accessTokenParser, loginRequired(crowi, app), page.api.updateLifetime)
  ...
  app.get('/_api/backlink.list', accessTokenParser, loginRequired(crowi, app), backlink.api.list)
  ...
  app.get('/_api/teams.list', accessTokenParser, loginRequired(crowi, app), team.api.list, team.middleware.handleError)
  app.get('/_api/teams.get', accessTokenParser, loginRequired(crowi, app), team.api.get, team.middleware.handleError)
  app.post('/_api/teams.create', accessTokenParser, loginRequired(crowi, app), team.api.create, team.middleware.handleError)
  app.post('/_api/teams.edit', accessTokenParser, loginRequired(crowi, app), team.api.edit, team.middleware.handleError)
  app.post('/_api/teams.addUser', accessTokenParser, loginRequired(crowi, app), team.api.addUser, team.middleware.handleError)
  app.post('/_api/teams.deleteUser', accessTokenParser, loginRequired(crowi, app), team.api.deleteUser, team.middleware.handleError)

  app.post('/_api/page_owners.activate', accessTokenParser, loginRequired(crowi, app), pageOwner.api.activate, pageOwner.middleware.handleError)
  app.post('/_api/page_owners.deactivate', accessTokenParser, loginRequired(crowi, app), pageOwner.api.deactivate, pageOwner.middleware.handleError)
