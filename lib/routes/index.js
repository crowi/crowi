module.exports = function(crowi, app) {
  ...
  const middlewares = require('../middlewares')(crowi, app)
  ...
  app.get('/me/auth/third-party', loginRequired, me.authThirdParty)
  app.post('/me', form.me.user, loginRequired, me.index)
  ...
  app.get('/me/notifications', loginRequired, me.notifications)
  app.post('/me/picture/delete', loginRequired, me.deletePicture)
  app.post('/me/auth/google', loginRequired, me.authGoogle)
  app.get('/me/auth/google/callback', loginRequired, me.authGoogleCallback)
  app.post('/me/auth/github', loginRequired, me.authGitHub)
  app.get('/me/auth/github/callback', loginRequired, me.authGitHubCallback)
