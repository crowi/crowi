module.exports = function(crowi, app) {
  var middleware = require('../util/middlewares')
    ...
    , fileAccessRightOrLoginRequired = middleware.fileAccessRightOrLoginRequired
  ...
  app.get( '/files/:id([0-9a-z]{24})' , fileAccessRightOrLoginRequired(crowi, app) , attachment.api.redirector);
  ...
  app.post('/_api/shares/secretKeyword' , accessTokenParser , loginRequired(crowi, app) , csrf, share.api.secretKeyword);
