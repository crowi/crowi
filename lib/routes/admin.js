module.exports = function(crowi, app) {
  ...
  actions.app = {}
  actions.api.app = {}
  actions.api.app.index = function(req, res) {
  ...
  actions.api.notification.index = async function(req, res) {
    ...
    return res.json(ApiResponse.success({ settings, slackSetting, hasSlackConfig, hasSlackToken, slackAuthUrl }))
  }
  ...
  actions.notification.slackSetting = function(req, res) {
    ...
    Config.updateNamespaceByArray('notification', slackSetting, async (err, config) => {
      if (err) {
  ...
  actions.api.search.buildIndex = async function(req, res) {
    ...
    try {
      ...
      debug('Error', err)
      return res.json(ApiResponse.error('Error while building index.'))
    }
  ...
  // app.post('/_api/admin/notification.add'    , admin.api.notificationAdd);
  ...
  // app.post('/_api/admin/notification.remove' , admin.api.notificationRemove);
