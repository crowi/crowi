module.exports = function(crowi, app) {
  ...
  var Notification = crowi.model('Notification')

  var NotificationStatus = crowi.model('NotificationStatus')
  ...
  actions.api.status = function(req, res) {
    ...
    NotificationStatus.findByUser(user)
  ...
  actions.api.statusRead = function(req, res) {
    ...
    NotificationStatus.updateIsReadFlag(user, true)
      .then(function(notificationStatus) {
        const result = {
          status: notificationStatus,
        }
