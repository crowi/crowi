...
See [RFC-0002: Renderer plugin architecture](../develop/rfcs) for the design
...
enabled. See [Managing plugins](../operations/plugins) for how to manage
plugins.
...
- [Managing plugins](../operations/plugins) — enabling renderer plugins
- [Renderer plugins](../operations/renderers) — configuring renderer plugins
- [RFCs and architecture](../develop/rfcs) — RFC-0002 renderer design
