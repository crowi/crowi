...
$(function () {
  ...
  var closePanel = function closePanel() {
    var $tr = $('#admin-users-table #target');

    if ($tr.length) {
      var $email = $tr.find('.email');
      var $emailInput = $email.find('input');
      var initial = $emailInput ? $emailInput.attr('initial') || '' : '';
      var $editPanel = $('#admin-users-table #edit-panel');
      var $padding = $('#admin-users-table .padding');
      $editPanel.on('animationend', function () {
        $tr.attr('id', '');
  ...
  var openPanel = function openPanel($tr) {
    var $email = $tr.find('.email');
    ...
    var $editPanel = {
      ...
      cancel: $('<button>', {
        type: 'button',
        class: 'cancel btn btn-default btn-sm'
      }).text('Cancel')
    };
    var $padding = $('<tr>', {
      class: 'padding'
    ...
    $tr.after($padding);
    $editPanel.cancel.on('click', function () {
      return closePanel();
    });
    $editPanel.update.on('click',
    /*#__PURE__*/
    _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee() {
      var id, email, csrf, body, _ref2, ok;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              csrf = $('#admin-users-table').data('csrf');
              body = {
                user_id: id,
                email: email,
                _csrf: csrf
              ...
              _context.next = 6;
              return window.crowi.apiPost('/admin/users.updateEmail', body);
