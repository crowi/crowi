...
var keys = __webpack_require__(1155);
var hasBinary = __webpack_require__(377);
var sliceBuffer = __webpack_require__(800);
var after = __webpack_require__(1152);
var utf8 = __webpack_require__(1156);

var base64encoder;
if (global && global.ArrayBuffer) {
  base64encoder = __webpack_require__(1153);
}
...
var Blob = __webpack_require__(859);
 ...
 *
 */
module.exports.parser = __webpack_require__(113);
...
var transports = __webpack_require__(371);
...
var parseuri = __webpack_require__(698);
var parsejson = __webpack_require__(1259);
...
Socket.transports = __webpack_require__(371);
Socket.parser = __webpack_require__(113);
...
var Polling = __webpack_require__(372);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(190)(module), __webpack_require__(20)))
...
exports = module.exports = __webpack_require__(1520);
exports.log = log;
...
var parseuri = __webpack_require__(698);
var debug = __webpack_require__(142)('socket.io-client:url');
...
exports.enable = enable;
exports.enabled = enabled;
exports.humanize = __webpack_require__(1522);
...
var isArray = __webpack_require__(1521);
var isBuf = __webpack_require__(777);
...
var io = __webpack_require__(798);
...
$(function () {
  ...
  $('#create-page').on('shown.bs.modal', function (e) {
    ...
    var newWidth = input2Width - $('#create-page-today .page-today-prefix').outerWidth() - $('#create-page-today .page-today-input1').outerWidth() - $('#create-page-today .page-today-suffix').outerWidth() - 42;
  ...
  if (pageId) {
    ...
    // omg
    var createCommentHTML = function createCommentHTML(revision, creator, comment, commentedAt) {
      var $comment = $('<div>');
      ...
      var $commentRevision = $('<a class="page-comment-revision label">').attr('href', '?revision=' + revision).text(revision.substr(0, 8));
      ...
      var $commentMeta = $('<div class="page-comment-meta">').text(commentedAt + ' ').append($commentRevision);

      var $commentBody = $('<div class="page-comment-body">').html(comment.replace(/(\r\n|\r|\n)/g, '<br>'));

      var $commentMain = $('<div class="page-comment-main">').append($commentCreator).append($commentBody).append($commentMeta);
    ...
    var AddToLikers = function AddToLikers(users) {
      $.each(users, function (i, user) {
        $likerList.append(CreateUserLinkWithPicture(user));
      });
    };

    var MarkLiked = function MarkLiked() {
      $likeButton.addClass('active');
      $likeButton.data('liked', 1);
      $likeCount.text(parseInt($likeCount.text()) + 1);
    };

    var MarkUnLiked = function MarkUnLiked() {
      $likeButton.removeClass('active');
      $likeButton.data('liked', 0);
      $likeCount.text(parseInt($likeCount.text()) - 1);
    };

    var CreateUserLinkWithPicture = function CreateUserLinkWithPicture(user) {
      var $userHtml = $('<a>');
    ...
    socket.on('page edited', function (data) {
      if (data.user._id != me && data.page.path == pagePath) {
...
exports = module.exports = __webpack_require__(1154);
exports.log = log;
exports.formatArgs = formatArgs;
exports.save = save;
exports.load = load;
...
var hasCORS = __webpack_require__(1178);
...
var debug = __webpack_require__(142)('socket.io-parser');
var Emitter = __webpack_require__(287);
var hasBin = __webpack_require__(377);
var binary = __webpack_require__(1523);
var isBuf = __webpack_require__(777);
...
var XMLHttpRequest = __webpack_require__(243);
var XHR = __webpack_require__(1150);
var JSONP = __webpack_require__(1149);
var websocket = __webpack_require__(1151);
...
var isArray = __webpack_require__(1177);
...
var eio = __webpack_require__(1146);
var Socket = __webpack_require__(776);
var Emitter = __webpack_require__(287);
var parser = __webpack_require__(288);
var on = __webpack_require__(775);
var bind = __webpack_require__(320);
var debug = __webpack_require__(142)('socket.io-client:manager');
var indexOf = __webpack_require__(168);
var Backoff = __webpack_require__(856);
...
var parser = __webpack_require__(288);
var Emitter = __webpack_require__(287);
var toArray = __webpack_require__(1527);
var on = __webpack_require__(775);
var bind = __webpack_require__(320);
var debug = __webpack_require__(142)('socket.io-client:socket');
var parseqs = __webpack_require__(173);
...
var url = __webpack_require__(1519);
var parser = __webpack_require__(288);
var Manager = __webpack_require__(774);
var debug = __webpack_require__(142)('socket.io-client');
...
exports.Manager = __webpack_require__(774);
exports.Socket = __webpack_require__(776);
