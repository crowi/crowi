...
export function PageSidebar({ path }: { path: string }) {
  return (
    <aside
      ...
      className="hidden min-[1440px]:block fixed top-24 right-[calc(50%+var(--shell-content)*0.5+var(--shell-gap))] w-[var(--shell-rail)] max-h-[calc(100vh-7rem)] overflow-y-auto z-30"
    >
