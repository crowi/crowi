...
/**
 * Confirmation dialog primitive used for irreversible (or hard-to-undo)
 * mutations such as "make admin" / "remove admin" / "suspend user".
 *
 * Modeled after the shadcn/ui AlertDialog: the surrounding API mirrors the
 * `Dialog` component above so callers can swap them when going from informational
 * dialogs to destructive confirmations.
 */
...
function AlertDialogTitle({ className, ...props }: React.ComponentProps<typeof AlertDialogPrimitive.Title>) {
  return <AlertDialogPrimitive.Title data-slot="alert-dialog-title" className={cn('text-lg leading-none font-semibold', className)} {...props} />;
}
