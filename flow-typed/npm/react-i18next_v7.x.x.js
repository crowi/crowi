...
declare module 'react-i18next' {
  ...
  ) => React$ComponentType<$Diff<React$ElementConfig<Component>, TranslatorPropsVoid>>
  ...
  declare function translate<P: {}, Component: React$ComponentType<P>>(
    namespaces?: string | Array<string> | (($Diff<P, TranslatorPropsVoid>) => string | Array<string>),
