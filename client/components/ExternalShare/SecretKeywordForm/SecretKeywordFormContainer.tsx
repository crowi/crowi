...
class SecretKeywordFormContainerComponent extends React.Component<Props, State> {
...
export const SecretKeywordFormContainer = withTranslation()(SecretKeywordFormContainerComponent)
